...
class HomePageState extends State<HomePage> {
  String _databaseInfo = '';
  bool _isLoading = true;
  String _loadingStatus = 'Initializing database...';
  ...
  Future<void> _initializeDatabase() async {
    setState(() {
      _isLoading = true;
      _loadingStatus = 'Initializing database...';
    });
    ...
    try {
      ...
      setState(() {
        _loadingStatus = 'Loading data...';
      });
      int stockCount = await DatabaseService.instance.getRecordCount('Stock');
      if (stockCount == 0) {
        await updateAllTables();
        setState(() {
          _loadingStatus = 'Populating database with initial data...';
        });
      }
      ...
      debugPrint('Error initializing database: $e');
      setState(() {
        _loadingStatus = 'Error loading data. Please try again.';
      });
    } finally {
      setState(() => _isLoading = false);
    }
                ...
                child: Column(
                  ...
                  children: [
                    const CircularProgressIndicator(
                      valueColor:
                          AlwaysStoppedAnimation<Color>(Color(0xffd9dcd6)),
                      strokeWidth: 3.0,
                    ),
                    ...
                    const Text(
                      'Please wait while the database is being set up with all required data',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Color(0xffd9dcd6),
                        fontSize: 14.0,
